...
public class FormatUtilities {
    ...
    /**
     * Adds blanks before or after the <code>text</code> passed as parameter until
     * the text has the
     ...
     *         according to
     *         <code>position</code> and with the width indicated by
     *         <code>size</code>
     */
    ...
    /**
     * Allows to query the user through the screen and returns an int with the user
     * input.
     *
     * @param message Message to show to the user
     * @return User input
